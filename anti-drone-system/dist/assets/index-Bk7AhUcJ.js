...
import App, { j as jsxRuntimeExports } from './__federation_expose_App-DACkigPX.js';
import { g as getDefaultExportFromCjs } from './_commonjsHelpers-BFTU3MAI.js';
import { r as reactExports } from './index-D82UUnuj.js';
import { r as reactDomExports } from './index-BRpUgLsv.js';
...
function getData() {
  ...
  var start,
    ...
    endValue = "value" in root$1 ? root$1.value : root$1.textContent,
  ...
  if (isComposing)
    return "compositionend" === domEventName ||
      ...
      ? ((domEventName = getData()),
        (fallbackText = startText = root$1 = null),
        (isComposing = false),
        domEventName)
      : null;
  switch (domEventName) {
      ...
      eventType &&
        (useFallbackCompositionData &&
          ...
          (isComposing || "onCompositionStart" !== eventType
            ...
            : ((root$1 = nativeEventTarget),
              (startText = "value" in root$1 ? root$1.value : root$1.textContent),
              (isComposing = !0))),
